...
class Spearfish(pygame.sprite.Sprite):
    def __init__(self, screen, SCREEN_WIDTH, SCREEN_HEIGHT, score = 0):
        ...
        self.set_up_images()
        self.caught_fish = []
        self.fish_info = {"gray_snapper": (self.fish_images[0], 2, 15), "goliath_grouper": (self.fish_images[1], 1, 100), "snook": (self.fish_images[2], 3, 20), "yellowfin_tuna": (self.fish_images[3], 4, 50), "tarpon": (self.fish_images[4], 2, 75), "bonefish": (self.fish_images[5], 3, 200), "mahi_mahi": (self.fish_images[6], 3, 75), "nausau_grouper": (self.fish_images[7], 1, 250), "sailfish": (self.fish_images[8], 10, 400), "swordfish": (self.fish_images[9], 8, 300), "wahoo": (self.fish_images[10], 10, 500)} 
    ...
    def set_up_images(self):
        ...
        self.goliath_grouper = pygame.image.load("Images/Goliath Grouper.png")
        self.snook = pygame.image.load("Images/Snook.png")
        self.yellowfin_tuna = pygame.image.load("Images/Yellowfin Tuna.png")
        self.tarpon = pygame.image.load("Images/TarponFish.png")
        self.bonefish = pygame.image.load("Images/bonefish.png")
        self.mahi_mahi = pygame.image.load("Images/mahi mahi.png")
        self.nausau_grouper = pygame.image.load("Images/nausau grouper.png")
